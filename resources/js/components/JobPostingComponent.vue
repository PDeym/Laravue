        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                <tr v-for="(item,index) in postingList" :key="item.id">
                    ...
                    <td>{{ item.vacants }}</td>
                    <td>
                        <button class="btn btn-success" @click="edit(item)"><i class="fa fa-edit"></i></button>
                    </td>
                    <td>
                        <button class="btn btn-danger" @click="remove(item,index)"><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Input Job Vacants" v-model="form.vacants">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Input Job Vacants" v-model="formEdit.vacants">
                    </div>
                </div>
...
export default{
    ...
    methods: {
        submit() {
            const vm = this;
            axios.post('/api/job_postings', this.form).then(function (response) {
        ...
        remove(item,index) {
            const vm = this;
            axios.delete(`/api/job_postings/${item.id}`).then(function (response) {
        ...
        save() {
            const vm = this;
            axios.put(`/api/job_postings/${this.selectedId}`, this.formEdit)
