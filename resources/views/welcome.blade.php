...
<body id="page-top">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            <p class="lead mb-0">Headquarters Philippine Army, Fort Bonifacio Global City
              <br>Taguig City, Metro Manila</p>
          </div>
    ...
    <section class="copyright py-4 text-center text-white">
      <div class="container">
        <small>All Rights Reserved. Philippine Army 2020</small>
      </div>
    </section>
